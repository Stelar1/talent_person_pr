...
<script type="text/javascript">
    $(function(){
        var msg;
        var subject;
        $.get("subject/getRandomSubject",function(data){
            ...
            loadData(msg,subject);
        });
    });
    function loadData(msg,subject){
        //得到属性个数
        ...
        for(item in msg){
            ...
            html="<div class='row span12 offset2 msg'><p>"+gettime(msg[item].m_time)+"</p>&nbsp;&nbsp;&nbsp;&nbsp;<P>你投送简历到</P>" +
                    "<a href='selectcruit/recruitdetail?rid="+subject[item].subjectTitle+"'>"+subject[item].subjectTitle+"</a>&nbsp;&nbsp;&nbsp;&nbsp;<p>"+hasRead(msg[item].m_status)+"</p></div>";
            $('#content').append(html);
        }
    }
    //将long转换为对象
