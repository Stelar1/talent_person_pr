...
<body>
			...
			<form id="searchForm" class="form-horizontal span24">
				<div class="row">
					<div class="control-group span8">
						...
						<div class="controls">
							<input type="text" class="control-text" name="rid" data-messages="{regexp:'不是有效的数字'}" data-rules="{number:true}">
						</div>
					</div>
					<div class="control-group span8">
	...
	<div id="content" class="hide">
		<form id="J_Form" class="form-horizontal">
			...
			<div class="row">
				<div class="control-group span8">
					<label class="control-label"><s>*</s>工作人数：</label>
					<div class="controls">
						<input id="rnum" name="rnum" data-rules="{required:true}" type="text" class="input-normal control-text"/>
					</div>
				</div>
				<div class="control-group span8">
					<label class="control-label"><s>*</s>工作地址：</label>
					<div class="controls control-row4">
						<input name="rplace" type="text" data-rules="{required:true}" class="input-normal control-text"/>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="control-group span8">
					<label class="control-label"><s>*</s>工作描述：</label>
					<div class="controls">
						<input id = "rdesc" data-rules="{required:true}" name="rdesc" type="text" class="input-normal control-text"/>
					</div>
				</div>
